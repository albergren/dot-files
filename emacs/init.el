...
(custom-set-variables
 ...
 '(org-capture-templates
   (quote
    (("b" "book" item
      (file+headline "/home/martin/notes/20200501191718-book_list.org" "Reading list")
      " %? 
"))))
 '(org-roam-directory "/home/martin/notes/")
 '(package-selected-packages
   (quote
    (nord-theme org-bullets org-superstar zetteldeft use-package org-roam-bibtex org-roam vue-mode typescript-mode ivy org fsharp-mode ant ac-emoji)))
...
;; Change text color when limit is excited
(require 'whitespace)
...
(setq org-roam-capture-templates
        '(("d" "default" plain (function org-roam--capture-get-point)
          ...
          ("a" "article" plain (function org-roam--capture-get-point)
			"%?" 
			:head "#+Title:${title}\n#+ROAM_ALIAS: \n#+DATE: %U\n%i:PROPERTIES:\n:LINK:\nENCOUNTERED:\n:CATEGORY: [[file:20200503131326-article.org][article]]\n:END:\n- tags :: "
			:file-name "%<%Y%m%d%H%M%S>-${slug}")
		  ("b" "book" plain (function org-roam--capture-get-point)
			"%?" 
			:head "#+Title: ${title}\n#+ROAM_ALIAS: \n#+DATE: %U\n%i:PROPERTIES:\n:AUTHOR:\n:ENCOUNTERED:\n:CATEGORY: [[file:20200503131213-book.org][book]]\n:END:\n- tags :: "
			:file-name "%<%Y%m%d%H%M%S>-${slug}")
          ("c" "contact" plain (function org-roam--capture-get-point)
           "%?"
           :file-name "%<%Y%m%d%H%M%S>-${slug}"
           :head "#+TITLE: ${title}\n#+ROAM_ALIAS: \n#+DATE: %U\n%i:PROPERTIES:\n:MET:\n:CATEGORY: [[file:20200503130943-contact.org][contact]]\n:END:\n- tags :: ")
          ("m" "movie" plain (function org-roam--capture-get-point)
           "%?"
           :file-name "%<%Y%m%d%H%M%S>-${slug}"
           :head "#+TITLE: ${title}\n#+ROAM_ALIAS: \n#+DATE: %U\n%i:PROPERTIES:\n:DIRECTOR:\n:YEAR:\n:ENCOUNTERED:\n:CATEGORY: [[file:20200503131101-movie.org][movie]]\n:END:\n- tags :: ")
		  ("p" "scientific paper" plain (function org-roam--capture-get-point)
			"%?" 
			:head "#+Title: ${title}\n#+ROAM_ALIAS: \n#+DATE: %U\n%i:PROPERTIES:\n:LINK:\nENCOUNTERED:\n:CATEGORY: [[file:20200503131439-paper.org][paper]]\n:END:\n- tags :: "
			:file-name "%<%Y%m%d%H%M%S>-${slug}")          
          ("s" "song" plain (function org-roam--capture-get-point)
           "%?"
           :file-name "%<%Y%m%d%H%M%S>-${slug}"
           :head "#+TITLE: ${title}\n#+ROAM_ALIAS: \n#+DATE: %U\n%i:PROPERTIES:\n:ARTIST:\n:ENCOUNTERED:\n:CATEGORY: [[file:20200503121032-song.org][song]]\n:END:\n- tags :: ")))          
